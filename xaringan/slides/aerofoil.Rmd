...
I tested three different turbulence models: a sinusoidal model, the Dryden model, and the Von Karman model. Dryden and Von Karman models have temporal correlation between the turbulence velocity at different times, while the sinusoidal model is temporally uncorrelated.
...
<div style="position: relative; height: 350px;">
  ...
  <img src="../figs/sinusoidal_pdf_psd.png"
       style="position:absolute; left:0%; top:20%; width:35%; cursor:pointer;"
       onclick="playAudio('audio1')">

  <!-- Image 2 -->
  <img src="../figs/dryden_pdf_psd.png"
       style="position:absolute; left:37%; top:20%; width:35%; cursor:pointer;"
       onclick="playAudio('audio2')">

  <!-- Image 3 -->
  <img src="../figs/von_kármán_pdf_psd.png"
       style="position:absolute; left:70%; top:20%; width:35%; cursor:pointer;"
